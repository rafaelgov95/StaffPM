...
public class PolicialSQL {
    ...
    public void updateStudent(PolicialPojo pojo) {
        try {
            connected();
//
            String sql = "Update Staff set nome='"+ pojo.getNome() + "',`idade` = " + pojo.getIdade() + ","+"`vcorrida` = "+ pojo.getVcorrida() +",`vapoio` = " + pojo.getVapoio() + ",`vbarras` = " + pojo.getVbarra() +",`vabdom`= " + pojo.getVabdom() +",`mcorrida`= " + pojo.getMcorrida() +",`mapoio`= " + pojo.getMapoio() + ",`mbarras` = " + pojo.getMbarra() +",`mabdom` = " + pojo.getMabdom() +" Where `id` = " + pojo.getId();
